    ...
    <section className="home" id="home">
        <div className="left-home">
            ...
            <div className="social-media">
                <a href="https://www.facebook.com/profile.php?id=61550617146422" target="_blank" rel="noreferrer" className="social-media-icon"><i className='bx bxl-facebook'></i></a>
                <a href="https://www.linkedin.com/in/soleman-noushad-b5a88128a/" target="_blank" rel="noreferrer" className="social-media-icon"><i className='bx bxl-linkedin' ></i></a>
                ...
                <a href="https://www.upwork.com/freelancers/~014f644e7f19ddf74e" target="_blank" rel="noreferrer" className="social-media-icon fiverr">fi</a>
            </div>
